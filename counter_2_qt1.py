...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_just_count.setGeometry(QtCore.QRect(0, 60, 600, 111))
...
"")
        ...
        self.entry = MyEntry(self.frame_just_count)
        self.entry.setGeometry(QtCore.QRect(10, 70, 401, 31))
...
"color: rgb(79, 103, 81);")
        ...
        self.add.setGeometry(QtCore.QRect(420, 70, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
...
"QPushButton:pressed {border-style: solid; background-color:  rgb(65, 85, 67)}")
        ...
        self.profile_frame_widget = QtWidgets.QFrame(self.frame_just_count)
        self.profile_frame_widget.setGeometry(QtCore.QRect(9, 30, 581, 31))
        self.profile_frame_widget.setAccessibleName("")
        self.profile_frame_widget.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.profile_frame_widget.setFrameShadow(QtWidgets.QFrame.Raised)
        self.profile_frame_widget.setObjectName("profile_frame_widget")
        self.frame_click_counter = QtWidgets.QFrame(self.centralwidget)
        self.frame_click_counter.setGeometry(QtCore.QRect(0, 180, 600, 171))
...
"border-radius: 10px;")
        ...
        self.click.setGeometry(QtCore.QRect(10, 30, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
...
"QPushButton:pressed {border-style: solid; background-color:  rgb(65, 85, 67)}")
        ...
        self.reset.setGeometry(QtCore.QRect(170, 30, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
...
"QPushButton:pressed {border-style: solid; background-color:  rgb(65, 85, 67)}")
        ...
        self.export_click.setGeometry(QtCore.QRect(260, 30, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
